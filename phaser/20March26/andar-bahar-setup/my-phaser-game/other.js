...
export default class Socket {
    ...
    async initializeConnection(loadGameCallback, clear) {
        ...
        const fullHubUrl =gs+ "hubs/VirAnderBahar1Hub?" + queryStringData //`${gs}hubs/Vir_1DayDragonTigerHub/?${queryStringData}`;
        ...
        try {
            ...
            GAME_INSTANCE.scene.start("ErrorScene");
            logging(
    ...
    handleConnectionClose() {
        // Utils.devLog("Connection closed");
        logging("Connection closed");
        // this.emitEventToGame();
        setTimeout(() => {
    ...
    subscribeToEvents() {
        ...
        // this.connection.on("onAuth", this.handleAuth.bind(this));
        this.connection.on(SOCKETEVENTS.ON_ROOM_JOINED, this.handleRoomJoined.bind(this));
        logging("room join handle success")
        this.connection.on(
            SOCKETEVENTS.ON_ROOM_JOIN_FAIL,
            this.handleRoomJoinFailed.bind(this)
        );
        ...
        switch (method) {
            ...
            case 14:
                ...
                setTimeout(function () {
                    ...
                    // logging(" METHOD14 error:", eventResponseJsonData.Data);
                    if (backURL == '') {
    ...
    handleTopFloaterAmt(data) {
        ...
        // Database.SetTopPlayerData(
        //     topPlayerDataJson.Data,
    ...
    sendGeneralBetRequestToSignalR(_betRes) {
        ...
        const betPlaceEncryptedData = DataEncryption(
